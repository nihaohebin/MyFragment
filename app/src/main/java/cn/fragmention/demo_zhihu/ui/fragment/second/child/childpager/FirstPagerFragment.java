package cn.fragmention.demo_zhihu.ui.fragment.second.child.childpager;
...
import cn.fragmention.demo_zhihu.adapter.HomeAdapter;
import cn.fragmention.demo_zhihu.entity.Article;
import cn.fragmention.demo_zhihu.event.TabSelectedEvent;
import cn.fragmention.demo_zhihu.listener.OnItemClickListener;
import cn.fragmention.demo_zhihu.ui.fragment.second.child.DetailFragment;
...
public class FirstPagerFragment extends SupportFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onTabSelectedEvent(TabSelectedEvent event) {
        if (event.position != ZhiHu_MainActivity.SECOND) return;
